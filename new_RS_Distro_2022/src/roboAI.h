...
*****************************************************************************/
#define PENALTY_GLOBAL_ERROR 0
#define PENALTY_GLOBAL_SET 1
#define PENALTY_TARGET_INFEASIBLE 2
#define PENALTY_TARGET_SELECTED 3
#define PENALTY_TARGET_REACHED 4
#define PENALTY_ALIGNED 5
#define PENALTY_SHOOT_COMPLETE 6
